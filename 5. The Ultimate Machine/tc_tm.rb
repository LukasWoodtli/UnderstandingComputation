...
class TestAdditionalPower < Test::Unit::TestCase
  def test_tm_with_internal_storage
    rulebook = DTMRulebook.new([
                    ...
                    TMRule.new(3, 'b', 3, 'b', :right), # skip 'b'
                    TMRule.new(3, 'c', 3, 'c', :right), # skip 'a'
                    ...
                    TMRule.new(4, 'c', 4, 'c', :right), # skip 'a'
  ...
  def test_subroutines
    ...
    rulebook = DTMRulebook.new(increment_rules(added_zero, added_one) +
